                ...
                <ul class="navbar-nav ml-auto">
                    ...
                    >
                        ...
                        <div
                            ...
                            id="notification_dropdown_menu_outer"
                        >
                            <h6
                                id="notifications_dropdown_item_header"
                                class="dropdown-header"
                            >
                                Alerts Center
                            </h6>
                            <a
                                id="notifications_dropdown_item_body"
                            ...
                            <a
                                id="notifications_dropdown_item_body_second"
                                class="dropdown-item d-flex align-items-center"
                                href="#"
                            >
                                <div class="mr-3">
                            ...
                            <a
                                id="notifications_dropdown_item_body_third"
                                class="dropdown-item d-flex align-items-center"
                                href="#"
                            >
                                <div class="mr-3">
