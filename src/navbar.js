              ...
              <li class="nav-item dropdown no-arrow mx-1" id="user_account_drop_down" >
                <a class="nav-link dropdown-toggle" id="userDropdown" role="button"
                      data-toggle="dropdown" aria-haspopup="true" onClick={ async () => {
                        ...
                        <div id="drop_down_login_user"><span class="mr-2 d-none d-lg-inline text-black-600 small" >Douglas McGee</span></div>
                </a>
                <div class={userMenuClass} aria-labelledby="userDropdown" id="user_dropdown_menu_outer">
                    <a class="dropdown-item d-flex align-items-center" href="#" id="user_dropdown_item_body_profile">
...
{/*<ul className='bar'>
      ...
      <li class="nav-item dropdown no-arrow" id="user_account_drop_down">
